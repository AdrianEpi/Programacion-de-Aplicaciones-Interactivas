...
* @Last Modified by:   AdriÃ¡n Epifanio
*/
'use strict';

/**
 * @desc Class Rectangle. This class is used for printing rectangles on the canvas of a given size.
 */
class Rectangle {
  ...
  drawRectangle(ctx, color) {  
    ...
    ctx.fillRect(this.startPoint.get_CoordinateX(), this.startPoint.get_CoordinateY(), this.width, this.height);
    ctx.stroke();
    ctx.closePath();
  }
}
